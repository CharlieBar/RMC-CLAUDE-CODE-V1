      ...
      <section className="relative py-20 lg:py-28 hero-gradient overflow-hidden">
        ...
        <div className="container container-default mx-auto relative z-10">
          <div className="max-w-3xl">
            <Badge
              className="mb-6 bg-amber-100 text-amber-700 animate-fade-in-up opacity-0"
            ...
            >
              Immediate Care{" "}
              <span className="gradient-text-medical">When You Need It</span>
            </h1>
            ...
            >
              <Button size="lg" shine prominent className="bg-amber-500 hover:bg-amber-600 group" asChild>
            ...
            <div
              className="flex flex-wrap gap-6 text-slate-600 animate-fade-in-up opacity-0"
            ...
            >
              ...
              <div className="flex items-center gap-2 group">
                <Stethoscope className="h-5 w-5 text-amber-500 transition-transform group-hover:scale-110" />
                <span className="group-hover:text-slate-900 transition-colors">On-Site X-Ray & Labs</span>
              </div>
            </div>
          </div>
        </div>
